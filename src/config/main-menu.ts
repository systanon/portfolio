...
export const mainMenu: NavigationMenu = [
  ...
  },
  {
    path: '/profile',
    text: 'Profile',
    i18n_key: 'header.nav-menu.profile',
    routeName: 'Profile',
    icon: '',
    showMode: 'authorized',
  },
  {
    path: '/about',
    text: 'About Me',
    i18n_key: 'header.nav-menu.about',
    routeName: 'About',
    icon: '',
    showMode: 'all',
  },
  {
    path: '/notes',
    text: 'Notations',
    i18n_key: 'header.nav-menu.notations',
    routeName: 'Notes',
    icon: '',
    showMode: 'authorized',
  },
  {
    path: '/contacts',
    text: 'Contacts',
    i18n_key: 'header.nav-menu.contacts',
    routeName: 'Contacts',
    icon: '',
    showMode: 'all',
  },
  {
    path: '/sign-in',
    text: 'Sign In',
    i18n_key: 'header.nav-menu.sign_in',
    routeName: 'SignIn',
    icon: '',
  ...
  },
  {
    path: '/sign-up',
    text: 'Sign Up',
    i18n_key: 'header.nav-menu.sign_up',
    routeName: 'SignUp',
    icon: '',
    showMode: 'unauthorized',
  },
